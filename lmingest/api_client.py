...
import lmingest.models
from lmingest import rest
...
class ApiClient(object):
  """Generic API client for HTTP client library builds.

  This client handles the client- server communication, and is invariant across
  implementations. Specifics of the methods and models for each application are generated from the Swagger
  templates.
  ...
  def __deserialize(self, data, klass):
    ...
    if type(klass) == str:
      ...
      if klass in self.NATIVE_TYPES_MAPPING:
        ...
        klass = getattr(lmingest.models, klass)
