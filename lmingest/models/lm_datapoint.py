...
class LMDataPoint(object):
  ...
  def aggregation_type(self):
    ...
    :return: The type of this LMDataPoint.
    :rtype: str
    """
  ...
  def description(self):
    ...
    :return: The description of this LMDataPoint.
    :rtype: str
    """
  ...
  def name(self):
    ...
    :return: The name of this LMDataPoint.
    :rtype: str
    """
    return self._name
  ...
  def type(self):
    ...
    :return: The aggregation_type of this LMDataPoint.
    :rtype: str
    """
    return self._type
  ...
  def to_dict(self):
    ...
    for attr, _ in six.iteritems(self.swagger_types):
      ...
      if isinstance(value, list):
        ...
        if value != None:
          result[attr] = value
    if issubclass(LMDataPoint, dict):
  ...
  def __eq__(self, other):
    ...
    if not isinstance(other, LMDataPoint):
      return False
